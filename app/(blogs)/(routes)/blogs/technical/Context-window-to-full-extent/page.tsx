  ...
  return (
    <div className={cn("min-h-screen justify-between flex flex-col gap-y-8 flex-1 pb-10 lg:px-[45vh] md:px-[20px] sm:px-[10px] text-[#141413]", isMobile && "px-[14px]")}>
      <div className="flex flex-col text-justify gap-4">
        ...
        <p className="text-xl font-semibold mt-3">With such huge windows, why even bother?</p>
        ...
        <p className="text-xl font-semibold mt-3">Understanding what a good context means?</p>
        ...
        <p className="text-xl font-semibold mt-3">Retrieval Augmented Generation</p>
        ...
        <p className="text-xl font-semibold mt-3">Compaction</p>
        ...
        <div className={cn("flex gap-5", isMobile && "flex-col gap-2")}>
            <div className="relative h-[13.5rem] min-w-[15rem]">
                <Image src={"/blogs/context_overload.png"} alt={""} fill/>
            </div>
        ...
        <p className="text-xl font-semibold mt-3">Structured note-taking / Memory files</p>
        ...
        <p className="text-xl font-semibold mt-3">Sub-agent architectures</p>
